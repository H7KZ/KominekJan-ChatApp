<script lang="ts">
    ...
    import {getLoggedInUserData, saveProfileChanges} from "/src/lib/functions/profile";
        ...
        >
            ...
            >
                <div class="relative">
                    ...
                    <div
                            class="absolute top-0 left-0 flex justify-center items-center rounded-full w-20 h-20 sm:w-28 sm:h-28 origin-center bg-[#0000008c]"></div>
                </div>
